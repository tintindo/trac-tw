...
<div id="content" class="browser">
 ...
 <div id="help">
  <strong>注意:</strong> 請參考 <a href="<?cs var:trac.href.wiki
  ?>/TracBrowser">TracBrowser</a> 以取得瀏覽源碼的使用說明.
 </div>
  ...
  <div id="anydiff">
   <form action="<?cs var:browser.anydiff_href ?>" method="get">
    <div class="buttons">
     ...
     <input type="submit" value="檢視變更..." title="準備一個任意的差異比對(Diff)" />
    </div>
   </form>
  </div>
